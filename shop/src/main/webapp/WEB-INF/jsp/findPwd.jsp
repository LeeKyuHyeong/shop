	...
	<div class="at-body">
		<div class="main_wrap">
			...
			<div class="row mt-5">
				...
				<form method="post" class="findPwdForm" id="findPwdForm" name="findPwdForm">
					<input type="hidden" name="next" value="{{next}}" />
					<h2>비밀번호 찾기</h2>
					<div class="idForm">
						<input type="text" id="loginId" name=loginId class="id" value=""
					...
					<button id="btn_pwd_find" class="btnfind" type="button">찾기</button>
					<div class="find_rel">
						<a id="btn_popup2" class="link_rel" href="findId.do">아이디 찾기</a>
					</div>
				</form>
